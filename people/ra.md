...
12.4 **Governing Law.** The formation, construction, performance and enforcement of this Agreement shall be in accordance with the laws of the Republic of China (ROC or Taiwan) and the city of Taipei. Any claim or action brought by one of the Parties hereto in connection with this Agreement shall be brought in the appropriate local governing authority or court located in the city of Taipei, and the Parties hereto irrevocably consent to the exclusive jurisdiction of such court.
...
### 13. RETAINER SCHEDULE AND TERMS

1. In the event of early termination before the “End Date”, both parties must agree to cancel the Agreement.
1. In case of early termination, the invoice due to the Service Provider for the entire Retainer Period is the Base Payment prorated by the total number of hours worked (divided by Total Retained Hours).

| Retainer Period | 4 weeks |
| Hours Worked Per Week | 30 |
| Total Retained Hours | 120 |
| Start Date | |
| End Date | |
| Base Payment | |
...
1. Invoice will be paid to “Service Provider” as Labor Remuneration (勞務報酬單)

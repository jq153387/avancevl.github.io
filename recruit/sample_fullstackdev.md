...
- [x] [贴了测验完成表格]({{ site.exam_submit_form_url }}){:target="_blank"}
...
| --- | --- | --- |
| 40 | 72% | 显示现在有在营业的餐厅 |
| 60 | 55% | 使用者可以搜寻有在营业的餐厅 |
| 50 | 81% | Google OAuth 登记帐户 |
| 50 | 0% | 后台管理员系统 管理：餐厅资讯 |
...
## 考题细节：网页功能
请自由选择你想要开发的功能，没有先后次序 **(照片是参考，不是指示):**

### 1. 表格显示：网页首页显示现在目前所有在营业的餐厅 (40分)

* 下载csv档案（有餐厅名字，台北营业时间）(用您的Gmail帐号登入下载）
* 使用者的时间查看 “此刻现在时间”（手机时间为准）
* 网页表格只要显示现在有开的餐厅
* 注意不同使用者的手机时间、时区
* 这也是您要开发网页的首页。使用者到您的网页首页，就要能看到这个表格：只显示现在此刻时间有在营业的餐厅名字清单

### 2. 搜寻功能：使用者可以用营业时段去搜寻有营业的餐厅 (60分)

* 使用者可以输入天、时间，查看搜寻的时段有在营业的餐厅

<img src="https://lh3.googleusercontent.com/E6qnWm-lHo5qDfBypb0HYc3qmV6IfzQTKc1TkR36HAEAvcGkZ4pxYEEfrBj_VfemiIUkN9W1gCFxfgmNgPhsLPLJlNAxPiX17SJXsASeNPK26dlocDmDa7wYZYaTITM3y1SlqoFlKg=w300">

* 搜寻结果是表格：显示有在指定搜寻时段内，有营业的餐厅和餐厅营业时间（台北时间）

<img src="https://lh3.googleusercontent.com/Gi1AyGX39dyePa8VMzKlNEOAMb8tBoRD1U-EMkLfXKhS2s4ELJil38lPOCNoDYBKnog8g_7T8HHNyUrYCwEb13HaKeZutikNWbz61eBzBfW4dlrvjdWtcXID83n2zWRKBWqcqPLVrg=w300">

### 3. 后端管理员控制台 (50分)

* 管理台有权限可以管理使用者和餐厅资讯 (15分)
* 管理餐厅资讯 (35分)

### 4. Google OAuth 使用者登记帐户功能 (50分)
